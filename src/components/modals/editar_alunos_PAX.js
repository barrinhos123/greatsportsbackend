...
import { adicinarAlunosAAula, adicinarAlunosPAXAAula } from "services/aulas/aulas_services"

function AdicionarAlunosPAX(props) {
          ...
          <Button
            onClick={() => {
              ...
              if (!constrolador) {
                ...
                adicinarAlunosPAXAAula(listaAux, props.aulaId).then(value => {
                  if (value == true) {
...
export default AdicionarAlunosPAX
